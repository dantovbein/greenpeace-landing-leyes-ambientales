  ...
  return useMemo(() => (
    <header className={styles.main}>
      ...
      <div className={styles.videoPlayer}>
        <iframe width="800" height="500" src="https://www.youtube.com/embed/ZVGEFVD64S8?si=7x8i2D0zNzlo2qUg" title="Salva las Leyes Ambientales" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
      </div>
