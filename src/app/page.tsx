...
export default function Home() {
  ...
  return (
    <section className={styles.main}>
      ...
      <strong>¡Exigí a los legisladores que no modifiquen las leyes ambientales incluidas en el proyecto de Ley Ómnibus!</strong>
      <FeedbackForm />
      <p>Al firmar la petición automáticamente le estará llegando un correo a los legisladores con tu reclamo. Compartí para que nuestra presión crezca y podamos salvar las leyes ambientales.</p>
